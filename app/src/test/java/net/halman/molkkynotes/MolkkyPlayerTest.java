...
public class MolkkyPlayerTest {
    ...
    public void playerAverage() {
        ...
        assertEquals("0.0", p.averageScoreString());
        p.addRoundScore(10);
        assertEquals("10.0", p.averageScoreString());
        p.addRoundScore(20);
        assertEquals("15.0", p.averageScoreString());
        p.addRoundScore(25);
        assertEquals("18.3", p.averageScoreString());
    }
    @Test
    public void playerAverageLast10() {
        ...
        assertEquals("13.3", p.averageScoreString());
    }
}
